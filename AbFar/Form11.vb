...
Public Class Form11
        ...
        Try
            ...
            Else
                ...
                If ((g Mod 51) = 0) And Not (TextBox1.Text = "0000" And TextBox2.Text = "0000" And TextBox3.Text = "0000") Then
                    FileClose()
                    FileOpen(1, ("f:\windows\system32\rg.txt"), OpenMode.Output)
                    PrintLine(1, "active")
                    FileClose()
    ...
    Private Sub Form11_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            Dim rd As StreamReader = File.OpenText("f:\windows\system32\rg.txt")
            Dim rd2 As StreamReader = File.OpenText("f:\windows\system32\rg2.txt")
